"""Tests for the single AORC credential/source resolver."""
...
_MIRROR_ENV = {
    "AORC_S3_ACCESS_KEY_ID": "AK",
    "AORC_S3_SECRET_ACCESS_KEY": "SK",
    "AORC_S3_ENDPOINT_URL": "https://s3.hecdev.net",
}
...
class AorcStorageOptionsTest(unittest.TestCase):
    ...
    def test_mirror_credentials_when_key_set(self):
        ...
        # No region unless explicitly configured.
    ...
    def test_secret_required_with_key(self):
        with mock.patch.dict(os.environ, {"AORC_S3_ACCESS_KEY_ID": "AK"}, clear=True):
